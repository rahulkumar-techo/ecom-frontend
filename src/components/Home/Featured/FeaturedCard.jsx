      ...
      >
        ...
        {FeaturedData.map((item, i) => {
          return (
            <SwiperSlide
              key={uniqid()}
              className="py-5 relative shadow-md  rounded-lg  bg-brand hover:bg-slate-200 transition delay-75 ease-in-out text-black hover_over_smallMenuList overflow-hidden"
            >
              {/* discount in percenage  */}
              <small className=" absolute left-2 w-auto bg-yellow-600 rounded-lg px-1 top-1 ">
                {item.discount}
              </small>
              ...
              <div className=" flex flex-col items-center rounded-lg px-5  relative  p-2  md:w-full">
                ...
                <div className=" absolute top-0 left-0 text-2xl ">
                  {/* show menu  product Sharing menulist */}
